...
class IsolatedWorld {
    constructor(client, frameManager, frame, timeoutSettings) {
        ...
        _IsolatedWorld_contextPromise.set(this, (0, util_js_1.createDeferredPromise)());
    ...
    clearContext() {
        ...
        __classPrivateFieldSet(this, _IsolatedWorld_contextPromise, (0, util_js_1.createDeferredPromise)(), "f");
    }
    setContext(context) {
